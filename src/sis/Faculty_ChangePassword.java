 ...
 */
public class Faculty_ChangePassword extends javax.swing.JFrame {
    ...
    public Faculty_ChangePassword(String id){
        initComponents();
    ...
    private Faculty_ChangePassword() {
    ...
    private void jButton_ChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ChangeActionPerformed
        ...
        if(verifyFields())
        {
            if(checkPassword())
            {
                ...
                String UpdateQuery = "UPDATE `faculty` SET `f_password`=? WHERE `faculty_id`=?";
                ...
                try {
                    ...
                    Logger.getLogger(Faculty_ChangePassword.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Faculty_ChangePassword.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Faculty_ChangePassword().setVisible(true);
            }
        });
    }
