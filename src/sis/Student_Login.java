...
public class Student_Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField_Studentid.setForeground(new java.awt.Color(153, 153, 153));
        jTextField_Studentid.setText("enter id");
        jTextField_Studentid.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                jTextField_StudentidFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                jTextField_StudentidFocusLost(evt);
            }
        });
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addComponent(jTextField_Studentid, javax.swing.GroupLayout.PREFERRED_SIZE, 29, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
    ...
    private void jTextField_StudentidFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField_StudentidFocusGained

        //clear the text field on focus if the text is "enter id"
        if(jTextField_Studentid.getText().trim().toLowerCase().equals("enter id"))
        {
            jTextField_Studentid.setText("");
            jTextField_Studentid.setForeground(Color.black);
        }

    }//GEN-LAST:event_jTextField_StudentidFocusGained

    private void jTextField_StudentidFocusLost(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_jTextField_StudentidFocusLost
        ...
        if(jTextField_Studentid.getText().trim().equals("") ||
            jTextField_Studentid.getText().trim().toLowerCase().equals("enter id"))
        {
            jTextField_Studentid.setText("enter id");
            jTextField_Studentid.setForeground(new Color(153,153,153));
        }

    }//GEN-LAST:event_jTextField_StudentidFocusLost
    ...
    private void jButton_LoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_LoginActionPerformed
        ...
        String student_id = jTextField_Studentid.getText();
        String password = String.valueOf(jPasswordField.getPassword());

        //create a select query to check if the username and the password exist in the
        String query = "SELECT * FROM `student` WHERE `student_id` = ? AND `s_password` = ?";
        ...
        try {
            ...
            {
                //show a new form
                Student_Portal form = new Student_Portal(student_id);
