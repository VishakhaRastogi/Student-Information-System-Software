...
public class Student_ChangePassword extends javax.swing.JFrame {
    ...
    public Student_ChangePassword(String id){
        initComponents();
    ...
    private Student_ChangePassword() {
    ...
    private void jButton_ChangeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton_ChangeActionPerformed
        ...
        if(verifyFields())
        {
            if(checkPassword())
            {
                ...
                String UpdateQuery = "UPDATE `student` SET `s_password`=? WHERE `student_id`=?";
                ...
                try {
                    ...
                    Logger.getLogger(Student_ChangePassword.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            else{
